	 ...
	 * @return 返回json数据类型<pre><code>
{
	...
	,height:''
	 // 申明表格列,width默认为100
	 // { text:"姓名",name:"username",width:100,style:'text-align:center;',reRender:function(rowData,td,rowIndex){return "aaa";} }
	,columns:[]
	...
	getOptions:function() {
		...
		return {
			 ...
			 * 	,reRender:function(rowData,td,rowIndex){return "aaa";}
			 *  ,sortName:'' }
			 */
			,columns:[]
			/**
