...
FDLib.extend(FDTextArea,FDFieldComponent);
 ...
 */
//@override
FDTextArea.prototype.getControlHtml = function() {
	return '<textarea name="' + this.options.name + '" ></textarea>';
}
...
// 重写父类的方法
//@override
FDTextArea.prototype.getControlItems = function() {
	return this.controlDiv.getElementsByTagName('textarea');
}
